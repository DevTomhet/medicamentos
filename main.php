  ...
  <body class="skin-blue fixed">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <!-- Modal Logout -->
        <div class="modal fase" id="logout">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="moda-title"><i class="fa fa-sign-out"> Salir</i></h4>
              </div>
              <div class="modal-body">
                <p>¿Seguro que quieres salir?</p>
              </div>
              <div class="modal-footer">
                <a href="logout.php" type="button" class="btn btn-danger">Si, Salir</a>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy <?php echo date('Y'); ?> - <a href="#" target="_blank">Sistema Web</a>.</strong>
      </footer>
    </div>
