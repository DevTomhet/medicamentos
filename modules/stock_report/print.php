        ...
        <tbody>
          ...
          if ($count == 0) {
            echo "<tr>
                    ...
                    <td style='padding-left:10px;' width='50', height='13' align='right' valign='middle'></td>
                    <td width='80' height='13' align='center' valign='middle'></td>
                  </tr>";
          } else {
            while ($data = mysqli_fetch_assoc($query)) {
              ...
              echo "<tr>
                      ...
                      <td style='padding-left:10px;' width='50', height='13' align='right' valign='middle'>$data[numero]</td>
