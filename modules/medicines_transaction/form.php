    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form class="form-horizontal" action="modules/medicines_transaction/proses.php?act=insert" role="form" name="formObatMasuk" method="post">
            <div class="box-body">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label">Código de transacción</label>
                <div class="col-sm-5">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <select name="transaccion" id="transaccion" class="form-control" onchange="hitung_total_stok();" required>
