    ...
    <div class="col-md-12">
      ...
      elseif ($_GET['alert'] == 3) {
        echo "<div class='alert alert-success alert-dismissable'>
                <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
                <h4><i class='icon fa fa-times-circle'></i> Exito!</h4>
      ...
      <div class="box box-primary">
        <!-- form start -->
        <form class="form-horizontal" action="modules/password/proses.php" role="form" method="post">
          <div class="box-body">
          ...
          <div class="box-footer bt-btn-action">
            <div class="form-group">
