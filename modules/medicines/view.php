<section class="content-header">
  <h1>
    ...
    <a href="?module=form_medicines&form=add" class="btn btn-primary btn-social pull-right" title="agregar" data-toggle="tooltip">
    ...
    <div class="col-md-12">
      ...
      elseif ($_GET['alert'] == 2) {
        echo "<div class='alert alert-success alert-dismissable'>
                <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
                <h4><i class='icon fa fa-check-circle'></i> Exito!</h4>
                 Datos del medicamento modificados correctamente.
              </div>";
      }
      elseif ($_GET['alert'] == 3) {
        echo "<div class='alert alert-success alert-dismissable'>
        ...
        <div class="box-body">
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            <tbody>
              <?php
              $no = 1;
              $query = mysqli_query($mysqli, "SELECT codigo,nombre,precio_compra,precio_venta,unidad,stock FROM medicamentos ORDER BY codigo DESC") or die ('Error: '.mysqli_error($mysqli));
              while ($data = mysqli_fetch_assoc($query)) {
                ...
                echo "<tr>
                        ...
                        <td width='180' align='right'>$ $precio_compra</td>
                        <td width='180' align='right'>$ $precio_venta</td>
