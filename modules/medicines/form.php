    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form class="form-horizontal" action="modules/medicines/proses.php?act=insert" method="POST">
            <div class="box-body">
              <?php
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" name="codigo" class="form-control" value="<?php echo $codigo; ?>" readonly required>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <select class="chosen-select" name="unidad" data-placement="-- Seleccionar --" autocomplete="off" required>
                    <option value=""></option>
...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      <div class="box box-primary">
        <!-- form start -->
        <form class="form-horizontal" action="modules/medicines/proses.php?act=update" method="post">
          <div class="box-body">
          ...
          <div class="box-footer">
            <div class="form-group">
              <div class="col-sm-offset-2 col-sm-10">
                <input type="submit" class="btn btn-primary btn-submit" name="Guardar" value="Guardar">
                <a href="?module=medicines" class="btn btn-defaul btn-reset">Cancelar</a>
              </div>
            </div>
          </div><!-- /.box footer -->
        </form>
