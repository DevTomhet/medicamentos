<section class="content-header">
  <h1>
    ...
    <a href="?module=form_user&form=add" class="btn btn-primary btn-social pull-right" title="Agregar" data-toggle="tooltip">
    ...
    <div class="col-md-12">
      ...
      elseif ($_GET['alert'] == 3) {
        echo "<div class='alert alert-success alert-dismissable'>
                <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
                <h4><i class='icon fa fa-check-circle'></i> Exito!</h4>
                El usuario ha sido activado correcamente.
              </div>";
      }
      ...
      elseif ($_GET['alert'] == 7) {
        echo "<div class='alert alert-danger alert-dismissable'>
                <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
                <h4><i class='icon fa fa-check-circle'></i> Error!</h4>
                Aseúrese de que el tipo de archivo subido sea *.JPG, *.JPEG, *.PNG.
              </div>";
      }
      ?>
      ...
      <div class="box box-primary">
        <div class="box-body">
          <table id="dataTables1" class="table table-bordered table-triped table-hover">
            <thead>
              <tr>
            ...
            <tbody>
              <?php
              $no = 1;
              $query = mysqli_query($mysqli,"SELECT * FROM usuario ORDER BY id_user DESC")
              ...
              while ($data = mysqli_fetch_assoc($query)) {
                echo "<tr>
                        ...
                        if ($data['foto'] == "") { ?>
                          <td class="center"><img src="images/user/user-default.png" class="img-user" width="45"></td>
                        <?php
                        } else { ?>
                          <td class="center"><img src="images/user/<?php echo $data['foto']; ?>" width="45" class="img-user"></td>
                        <?php
                        }
