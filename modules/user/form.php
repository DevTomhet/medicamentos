    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form class="form-horizontal" role="form" action="module/user/proses.php?act=insert" enctype="multipart/form-data" method="post">
            <div class="box-body">
...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      <div class="box box-primary">
        <!-- form start -->
        <form class="form-horizontal" role="form" action="modules/user/proses.php?act=update" enctype="multipart/form-data" method="post">
          <div class="box-body">
